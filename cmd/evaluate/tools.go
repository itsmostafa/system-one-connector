...
type evaluateIn struct {
	...
	Model     string              `json:"model,omitempty" jsonschema:"model to use; defaults to the latest Jev on whichever endpoint is configured, or to TYPESAFE_MODEL when that is set"`
